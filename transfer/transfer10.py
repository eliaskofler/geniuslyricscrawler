...
print("Fetching album URLs from the 'albums' table in 'geniuslyrics'...")
# Fetch URLs from the "album" table in "geniuslyrics"
cursor_geniuslyrics.execute("SELECT url FROM albums")
album_urls = cursor_geniuslyrics.fetchall()
print(f"Fetched {len(album_urls)} album URLs from 'album'.")
