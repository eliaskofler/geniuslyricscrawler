...
print("Fetching artist URLs from the 'artists' table in 'geniuslyrics'...")
# Fetch URLs from the "artists" table in "geniuslyrics"
cursor_geniuslyrics.execute("SELECT url FROM artists")
artist_urls = cursor_geniuslyrics.fetchall()
print(f"Fetched {len(artist_urls)} artist URLs from 'artists'.")
