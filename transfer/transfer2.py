...
print("Fetching URLs from the 'album_songs' table in 'geniuslyrics'...")
# Fetch URLs from the "album_songs" table in "geniuslyrics"
cursor_geniuslyrics.execute("SELECT song_url FROM album_songs")
song_urls = cursor_geniuslyrics.fetchall()
print(f"Fetched {len(song_urls)} URLs from 'album_songs'.")
